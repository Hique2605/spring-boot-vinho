...
public class WineAdapter extends RecyclerView.Adapter<WineAdapter.WineViewHolder> {
    ...
    public static class WineViewHolder extends RecyclerView.ViewHolder {
        TextView nameTextView, typeTextView, priceTextView, idWine;
        ImageView imageWine;
        ...
        public WineViewHolder(View itemView) {
            ...
            idWine = itemView.findViewById(R.id.textWineId);
    ...
    public void onBindViewHolder(WineViewHolder holder, int position) {
        ...
        holder.nameTextView.setText("Nome: " +wine.getNome());
        holder.idWine.setText("Id:" +String.valueOf(wine.getId()));
        holder.typeTextView.setText("Tipo: " +wine.getTipo());
