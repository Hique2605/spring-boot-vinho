...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Vinho v1 = new Vinho(null, "Vinho Tinto", "2020", "Tinto", "Cabernet", "13%", "750ml",
				"Notas frutadas", "Carnes vermelhas", 89.90, null, 50.0, true);
		Vinho v2 = new Vinho(null, "Vinho Branco", "2021", "Branco", "Chardonnay", "12%", "750ml",
				"Aroma floral", "Peixes", 69.90, null, 30.0, true);
		...
		vinhoRepository.saveAll(Arrays.asList(v1, v2, v3, v4, v5, v6));

		// Representantes
		Representante r1 = new Representante(null, "Carlos Silva", "carlos@rep.com", "11999999999", "senha123", 5000.0);
		Representante r2 = new Representante(null, "Fernanda Lima", "fernanda@rep.com", "11988888888", "senha456", 7000.0);
		Representante r3 = new Representante(null, "Carleto Pedra", "fernanda@rep.com", "11988888888", "senha456", 7000.0);
		...
		User u3 = new User(null, "Para de guaio", "guaio@gmail.com", "977777777", "123456");
		...
		//cria admin
		Admin adm01 = new Admin(null,"Hique","hique@gmail.com","99885625","555");
